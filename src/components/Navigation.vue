<template>
  <div class="flex px-6 py-4 justify-between shadow-md items-center font-['Jetbrains']">
    ...
    <a class="block px-4 py-2 text-white hover:bg-gray-800" href="https://www.lebra.ee/">Muusika</a>
    ...
    <button class="lg:hidden flex text-black focus:outline-none " @click="isOpen = !isOpen">
