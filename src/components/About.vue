<template>
        <div id="minust" class="text-white text-center flex flex-col justify-center items-center gap-12 h-screen p-8">
            <div class="lg:grid justify-between lg:grid-cols-2 gap-24">
                ...
                <iframe class="hidden lg:h-[60vh] lg:block w-full lg:w-[32rem] rounded-lg" width="" height="" src="https://www.youtube.com/embed/oWtC29ZQcOw?si=qvb3bygcHRF0Xjzt" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
        </div>
</template>