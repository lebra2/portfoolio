<template>
        <div id="minust" class="text-white text-center shadow-md bg-white bg-opacity-5 lg:p-8 h-screen">
            <div class="">
                <h1 class="text-6xl font-semibold pt-8 font-['South']">LEBRA</h1>
