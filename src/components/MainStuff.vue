<template>
    <div class="font-['Jetbrains'] h-screen flex flex-col justify-center items-center p-4 ">
        <div class=" h-full lg:pt-24 lg:pt-0">
            <img class="fixed h-screen w-screen scale-200 -z-50" src="../assets/Pictures/kiilakas.png" alt="" style="object-fit: cover; filter: brightness(1) blur(5px) saturate(0.5);">
  
            <div class="flex border-4 justify-center items-center lg:pt-16">
