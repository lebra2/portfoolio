    ...
    <div class="font-['Jetbrains'] h-screen flex flex-col justify-center items-center px-8 ">
        <div class=" h-full pt-12">
            ...
            <div class="flex justify-center items-center">
                <a class="" href="https://www.youtube.com/watch?v=c54uODoCXl8" target="_blank"><img class="w-[32rem] lg:w-[60vh] lg:h-[60vh]" src="../assets/Pictures/hoolid.jpeg" alt="" style="object-fit:cover"></a>
            </div>
            <div class="gap-2 text-white text-2xl flex justify-center flex-col items-center">
                <h1 class="text-3xl mt-4 text-second">Hoolid</h1>
